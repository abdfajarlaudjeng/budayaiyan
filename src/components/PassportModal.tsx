          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-stone-400 font-light">
                Koleksi stempel penjelajahan dan lencana apresiasi cagar budaya
              </p>
            </div>
          </div>
            ...
            <div className="p-5 rounded-3xl bg-[#d4a373]/10 border border-[#d4a373]/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-lg">
              <div className="flex items-center gap-3">
                ...
                <div className="text-xs sm:text-sm text-stone-200 font-light">
                  <strong className="text-white font-medium">Selamat!</strong> Anda berhak mencetak Lencana Partisipasi Apresiasi Cagar Budaya Donggala.
                </div>
              </div>
              <button
